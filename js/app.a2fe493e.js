        ...
        var n = a("2b0e"),
            r = function () {
                ...
                return n("v-app", [n("header", {
                    ...
                    attrs: {
                        href: "https://tronscan.org/#/contract/TRL5aZ8vu5cBCCZ4TRWLdM97MF69eUSig3"
                    }
            ...
            l = a("7f45"),
            c = a.n(l),
            u = "TRL5aZ8vu5cBCCZ4TRWLdM97MF69eUSig3",
            ...
            methods: {
                ...
                getUserBalance: function () {
                    ...
                    this.mainContract.balanceOf(this.user.address).call({
                        ...
                        t.user["balance"] = parseFloat(window.tronWeb.fromSun(e)) / 100, t.yourTokenBalanceHd = "Your HFM balance: " + t.user["balance"]["toLocaleString"]()
                    }))
                },
                ...
                run_Stake: function (t) {
                    ...
                    console.log("in run_Stake==>>>"), this.mainContract.globalInfo().call({
                        ...
                        e.stakeData.stakingShare = window.tronWeb.fromSun(t[2]["_hex"]) * e.SUN, e.stVal1 = e.currentDay + 1, e.stakeData.shareRate = 1e5 / e.stakeData.stakingShare * 1e8, e.stVal12 = e.abbreviate_number(e.stakeData.shareRate, 2) + "/HFM"
                                                        ...
                                                        case 2:
                                                            ...
                                                            for (d = 0, n.divRewards = 0, f = 0, v = parseFloat(window.tronWeb.fromSun(o._hex)) / 100, b = function (t) {
                                                                a.daysData.forEach((function (e) {
                                                                    e.day == r + t && (f += .90 * e.totalDividends * v / e.stakeSharesTotal, d = a.abbreviate_number(100 * f, 10) + " TRX")
                                                                }))
                                                            }, p = 0; p < s; p++) b(p);
                                    ...
                                    case 7:
                                        s = a.sent, setTimeout(Dt(i.a.mark((function a() {
                                            ...
                                            return i.a.wrap((function (a) {
                                                while (1) switch (a.prev = a.next) {
                                                    case 0:
                                                        return a.next = 2, ut.a.get("".concat("https://api.shasta.trongrid.io", "/v1/transactions/").concat(s, "/events"));
                                                    case 2:
            ...
            he = {
                ...
                methods: {
                    ...
                    calcDaysLobbyPayout: function (t) {
                        return t <= 60 ? 25e12 - 2500 * ( 10 ** 8) * (t - 1) : 1e13
                    },
                    getCurrentDay: function () {
